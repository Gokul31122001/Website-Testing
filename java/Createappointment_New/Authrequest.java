...
public class Authrequest {
		...
		public static void main(String[]args) throws InterruptedException, AWTException, IOException {
			IndividualTheraphy authreq=new IndividualTheraphy();
			...
			authreq.saveReport("Authrequest"+d+".html",tblcss+"<table border='1'><tr><th colspan=14><center>Authrequest Authentication</center></th>"+Columnames);
